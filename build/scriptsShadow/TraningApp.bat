...
set CLASSPATH=%APP_HOME%\lib\TrainingApp-1.0-SNAPSHOT-all.jar

@rem Execute TraningApp
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TRANING_APP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TRANING_APP_EXIT_CONSOLE%" exit 1
exit /b 1
